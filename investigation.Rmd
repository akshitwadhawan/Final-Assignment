...
```{r}
#Predominant function of establishment against age scatterplot
...
ggplot(data, aes(
    ...
    geom_count(color="steelblue", alpha = 0.7) +
    scale_size_area(max_size = 20) +
    labs(
        title = "Count Plot: Frequency of Establishment Function by Age Group",
        x = "Age group",
        y = "Predominant function of establishment",
        size = "Count"
    ) +
